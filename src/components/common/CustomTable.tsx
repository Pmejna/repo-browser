import { 
  ...
  const CustomTablePaginated: FunctionComponent<CustomTablePaginatedProps> = ({ columns, data, isLoading, numberOfItems }) => {
        ...
        <>
          {
            ...
            (
              <>
                <Table {...getTableProps()}>
                  {
                      data && <TableCaption background="gray.900" color="gray.100">Github repository <Text as="span" color="blue.500">{numberOfItems ? numberOfItems : 0}</Text> search results</TableCaption>
                  } 
